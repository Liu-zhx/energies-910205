...
%     rn=[];
u0=4*pi*1e-7;
mx=50;    my=1851*5;   mz=29*5;    M=[mx;my;mz];   %Magnetic moment of magnetic source
...
% xlswrite('D:\¡ı÷“œÈ\matlab data\dn_magnetic_strength',dn)
% xlswrite('D:\¡ı÷“œÈ\matlab data\dnr_magnetic_strength',dnr)
