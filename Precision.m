...
%1nT Sensor accuracy
% Bxy1=roundn(Bxy,-9);Bxz1=roundn(Bxz,-9);Byy1=roundn(Byy,-9);Byz1=roundn(Byz,-9);Bzz1=roundn(Bzz,-9);   
% Byx1=roundn(Byx,-9);Bzx1=roundn(Bzx,-9);Bzy1=roundn(Bzy,-9);Bxx1=roundn(Bxx,-9);
% B(:,1)=roundn(B(:,1),-9);
% G=[Bxx1 Bxy1 Bxz1;Byx1 Byy1 Byz1;Bzx1 Bzy1 Bzz1];

%0.01nT=10pT    Sensor accuracy             y = ROUNDN(x,n) %To the exact number n after the decimal point
...
%1pT=10^-12T=10^-3nT Sensor accuracy
...
%0.1pT=10^-4nT     Sensor accuracy            y = ROUNDN(x,n) 
...
dnr=(dnx1.^2+dny1.^2+dnz1.^2).^0.5;%Total error


% xlswrite('D:\¡ı÷“œÈ\matlab data\dn_precision',dn)
% xlswrite('D:\¡ı÷“œÈ\matlab data\dnr_precision',dnr)
